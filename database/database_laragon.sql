...
-- Dumping data for table ictdu_hms.categories: ~1 rows (approximately)
...
-- Dumping data for table ictdu_hms.checkouts: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `invoices` (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5003 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ictdu_hms.invoices: ~1 rows (approximately)
