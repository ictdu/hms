                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="check_in_date" class="form-control date-picker <?php echo (!empty($data['check_in_date_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['check_in_date']; ?>" placeholder="DD / MM / YYYY" type="text">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="check_out_date" class="form-control date-picker <?php echo (!empty($data['check_out_date_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['check_out_date']; ?>" placeholder="DD / MM / YYYY" type="text">
